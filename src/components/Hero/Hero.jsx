    ...
    return (
        <motion.div initial={{ y: -500, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="md:h-[600px] py-[90px] bg-blue-50 sm:p-64 flex items-center justify-center">
            <div className="releative flex flex-col items-center justify-center">
                ...
                <Link to={'/dashboard'}><button type="button" style={{ fontFamily: 'Happy Monkey, sans-serif' }} className="flex items-center justify-center px-3 py-2 sm:px-4 sm:py-3 hover:bg-[#488B54] bg-[#1E2F5B] rounded-2xl text-slate-50 font-semibold transition delay-100">Go to Dashboard</button></Link>
            </div>
